...
import { Zap, DollarSign, BarChart2, ArrowDownRight, ArrowUpRight } from "lucide-react";

const overviewData = [
	{ name: "Active Campaigns", value: "567", change: 12.5, icon: Zap },
	{ name: "Total Budget", value: "$12,345", change: -3.2, icon: DollarSign },
	{ name: "CTR (Click-Through Rate)", value: "12.5%", change: 15.7, icon: BarChart2 },
];
